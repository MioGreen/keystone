...
/**
 * CloudinaryVideos FieldType Constructor
 * @extends Field
 * @api public
 */

function cloudinaryvideos(list, path, options) {
	...
	if (options.initial) {
		throw new Error('Invalid Configuration\n\n' +
			'CloudinaryVideos fields (' + list.key + '.' + path + ') do not currently support being used as initial fields.\n');
	}

	cloudinaryvideos.super_.call(this, list, path, options);

	// validate cloudinary config
	if (!keystone.get('cloudinary config')) {
		throw new Error('Invalid Configuration\n\n' +
			'CloudinaryVideos fields (' + list.key + '.' + this.path + ') require the "cloudinary config" option to be set.\n\n' +
...
util.inherits(cloudinaryvideos, super_);
...
cloudinaryvideos.prototype.addToSchema = function() {
...
cloudinaryvideos.prototype.format = function(item) {
...
cloudinaryvideos.prototype.isModified = function(item) {
...
cloudinaryvideos.prototype.validateInput = function(data) {
...
cloudinaryvideos.prototype.updateItem = function(item, data) {
...
cloudinaryvideos.prototype.getRequestHandler = function(item, req, paths, callback) {
...
cloudinaryvideos.prototype.handleRequest = function(item, req, paths, callback) {
...
exports = module.exports = cloudinaryvideos;
