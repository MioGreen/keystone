...
function cloudinaryfiles(list, path, options) {
	...
	cloudinaryfiles.super_.call(this, list, path, options);
...
util.inherits(cloudinaryfiles, super_);
...
cloudinaryfiles.prototype.addToSchema = function() {
...
cloudinaryfiles.prototype.format = function(item) {
...
cloudinaryfiles.prototype.isModified = function(item) {
...
cloudinaryfiles.prototype.validateInput = function(data) {
...
cloudinaryfiles.prototype.updateItem = function(item, data) {
...
cloudinaryfiles.prototype.getRequestHandler = function(item, req, paths, callback) {
...
cloudinaryfiles.prototype.handleRequest = function(item, req, paths, callback) {
...
exports = module.exports = cloudinaryfiles;
